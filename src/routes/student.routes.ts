...
class StudentRouter{
    ...
    public routes():Router{
        ...
        this.studentRouter.get('/:id/login-history', isAuth(authStudent), this.instanceController.getLogginHistory);  //Get login history by studentId
        this.studentRouter.put('/:id', isAuth(authStudent), this.instanceController.updateStudent); //Update student
